...
const [dialog, setDialog] = useState(“signin”);
...
function changeDialog(nextDialog: DialogType) {
...
try {
  if (!supabase) {
    throw new Error(
      "Authentication is not configured. Please check your Supabase environment variables."
    );
  }
  if (dialog === "signup") {
  ...
  <main className="auth-page">
    <section className="auth-card">
      <div className="auth-brand">
        ...
        <p>
          Your dedicated research workspace for
          projects, datasets, articles, notes and
          discoveries.
        </p>
      </div>
